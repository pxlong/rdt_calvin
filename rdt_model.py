...
print(f"GALAXEA_STATE_INDICES: {CALVIN_STATE_INDICES}")
...
class RoboticDiffusionTransformerModel(object):
    ...
    def _format_obs_to_state(self, obs):
        ...
        obs = self._convert_ee_pose_to_6d(obs)

        # Fill into the unified state vector
        state[:, :, CALVIN_STATE_INDICES] = obs
        ...
        state_elem_mask[:, CALVIN_STATE_INDICES] = 1
