...
class RDTRunner(
    ...
    def build_condition_adapter(self, projector_type, in_features, out_features, dtype):
        projector = None
    ...
    def adapt_conditions(self, lang_tokens, img_tokens, state_tokens):
        ...
        # print(f"adapt-lang_tokens type: {lang_tokens.dtype}")
        # print(f"adapt-img_tokens type: {img_tokens.dtype}")
        # print(f"adapt-state_tokens type: {state_tokens.dtype}")
    ...
    def conditional_sample(
        ...
        # print(f"sample-lang_cond type: {lang_cond.dtype}, dtype: {dtype}")
    ...
    def predict_action(
        ...
        # print(f"pred-lang_tokens type: {lang_tokens.dtype}")
        # print(f"pred-img_tokens type: {img_tokens.dtype}")
        # print(f"pred-state_tokens type: {state_tokens.dtype}")
